...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchDisplayDelegate {
    ...
    override func viewDidLoad() {
        ...
        todos = [TodoModel(id: "1", image: "child-selected", title: "1. Summer Camp", date: dateFromString("2014-10-20")!),
                TodoModel(id: "2", image: "shopping-cart-selected", title: "2. Groceries", date: dateFromString("2014-10-28")!),
                TodoModel(id: "3", image: "phone-selected", title: "3. Call Mom", date: dateFromString("2014-10-30")!),
